...
import com.harshal.request.IngredientCategoryRequest;
import com.harshal.request.IngredientRequest;
import com.harshal.service.IngredientsService;
...
public class IngredientController {
    ...
    public ResponseEntity<List<IngredientsCategory>>getRestaurantIngredientCategory(
        ...
        List<IngredientsCategory> item=ingredientsService.findIngredientsCategoryByRestaurantId(id);
        return new ResponseEntity<>(item, HttpStatus.OK);
    }
}
