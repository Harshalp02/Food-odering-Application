...
const validationSchema = Yup.object({
    ...
    pincode: Yup.number() // Ensure it's a number type
        .required("Pincode is required") // Use the required method correctly
        .typeError("Pincode must be a number"), // Validate number type
    ...
    return (
        <>
            ...
            <main className="lg:flex justify-between">
                <section className="space-y-6 lg:w-[30%] lg:min-h-screen pt-3">
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12}>
                                <Field
                                    ...
                                    fullWidth
                                    variant="outlined"
                                    error={!<ErrorMessage name="streetAddress" />}  // Fix error prop
                                    helperText={
                            ...
                            <Grid item xs={6}>
                                <Field
                                    ...
                                    fullWidth
                                    variant="outlined"
                                    error={!<ErrorMessage name="state" />}  // Fix error prop
                                    helperText={
                            ...
                            <Grid item xs={6}>
                                <Field
                                    ...
                                    fullWidth
                                    variant="outlined"
                                    error={!<ErrorMessage name="city" />}  // Fix error prop
                                    helperText={
                            ...
                            <Grid item xs={12}>
                                <Field
                                    ...
                                    fullWidth
                                    variant="outlined"
                                    error={!<ErrorMessage name="pincode" />}  // Fix error prop
                                    helperText={
