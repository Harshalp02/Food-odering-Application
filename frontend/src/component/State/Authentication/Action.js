...
export const registerUser=(reqData)=>async(dispatch)=>{
    ...
    try{
        ...
        if(data.role==="ROLE_REATAURANT_OWNER"){
...
export const loginUser=(reqData)=>async(dispatch)=>{
    ...
    try{
        ...
        dispatch({type:LOGIN_SUCCESS, payload: data.jwt}); // Add JWT to state

        // Log user role and JWT after success
        console.log("Login success, JWT:", data.jwt, "Role:", data.role);

        // Dispatch action to get user details
...
export const getUser=(jwt)=>async(dispatch)=>{
    ...
    try{
        ...
        // Log the user data after fetching
